...
public class SharedUtil {
	private Context ctx;
	private String FileName = "joy_face";

	private static final String ID_FACE_SET_CREATED = "face_set_created";

	public SharedUtil(Context ctx) {
		this.ctx = ctx;
	}

	public boolean isFaceSetCreate(){
		return getBooleanValueByKey(ID_FACE_SET_CREATED);
	}

	public void setFaceSetCreate(){
		saveBooleanValue(ID_FACE_SET_CREATED, true);
	}
